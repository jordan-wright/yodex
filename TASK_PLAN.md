...
- [x] Script generation via sectioned prompts (intro/topic/game/brain-bite/outro), continuity anchors, Markdown rendering, and basic lexical safety check (`cmd/yodex/script.go`, `internal/podcast/*`).
...
- [ ] Script structure: DESIGN expects Intro/Main/Fun Facts/Jokes/Recap/Question; current sections are Intro/Topic/Game/Brain Bite/Outro.
...
- [x] Generate and store section outputs as separate files: `intro.md`, `topic.md`, `game.md`, `brain-bite.md`, `outro.md`.
- [x] Update audio pipeline to concatenate intro + topic + game + brain-bite + outro.
